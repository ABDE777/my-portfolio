...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1A1F2C] text-white py-12 px-6 md:px-12">
          ...
          <div>
            ...
            <div className="mt-6 flex space-x-4">
              <a
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-[#222733] hover:bg-purple-600 transition-colors duration-300"
