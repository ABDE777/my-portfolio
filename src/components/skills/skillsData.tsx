...
import { 
  FaGraduationCap, FaCertificate, FaCode, FaBriefcase, FaUsers
} from "react-icons/fa";
import { 
  SiHtml5, SiCss3, SiJavascript, SiPython, SiPhp,
  SiBootstrap, SiGit, SiGithub, SiWindowsterminal,
  SiVisualstudiocode, SiVercel, SiMysql, SiMicrosoftexcel,
  SiMicrosoftword, SiMicrosoftpowerpoint, SiGoogle
} from "react-icons/si";
...
const getTerminalIcon = (): ReactNode => <SiWindowsterminal className="text-blue-400 text-4xl" />;
const getVsCodeIcon = (): ReactNode => <SiVisualstudiocode className="text-blue-500 text-4xl" />;
const getVercelIcon = (): ReactNode => <SiVercel className="text-slate-100 text-4xl" />;
const getExcelIcon = (): ReactNode => <SiMicrosoftexcel className="text-green-600 text-4xl" />;
const getWordIcon = (): ReactNode => <SiMicrosoftword className="text-blue-700 text-4xl" />;
const getPowerPointIcon = (): ReactNode => <SiMicrosoftpowerpoint className="text-red-600 text-4xl" />;
