...
const GitHubStats = () => {
  ...
  if (isLoading) {
    return (
      <section className="py-24 bg-gradient-to-b from-indigo-950 via-blue-950 to-cyan-950">
  ...
  return (
    <section id="github-stats" className="py-24 bg-gradient-to-b from-indigo-950 via-blue-950 to-cyan-950 relative overflow-hidden">
      {/* Background effects */}
